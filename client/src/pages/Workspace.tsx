...
function Brand() { return <Link href="/" className="brand-lockup workspace-brand"><span className="brand-mark">Y</span><span className="brand-word">Yaya<span>Aiki</span></span></Link>; }
